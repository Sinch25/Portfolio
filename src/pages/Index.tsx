...
const Index = () => {
  ...
  const aboutSections = [
    {
      ...
      content:
        "I stepped foot into the technical world by learning C and Java in school, and that's where it all started - my passion for coding. Out of my interest, I started experimenting with the languages and found myself drawn to DSA. This journey led me to explore competitive programming, where I continue to challenge myself and grow.",
    },
    {
      title: "Open Source",
      icon: <Github className="w-6 h-6 text-vivid-purple" />,
      content:
        "I learnt about open-source and contributions a few months ago and I'm a huge fan of it! I loved contributing to Hacktoberfest-24 and GSSoC Ext.-24. Making my GitHub completely green is something I envision soon enough.",
    },
    {
      title: "Web Development",
      icon: <Brain className="w-6 h-6 text-vivid-purple" />,
      content:
        "Now, I aim to conquer the domain of web development and although I'm still a rookie front-end specialist, I can assure you that I will meet my goals soon enough.",
    },
    {
      title: "IoT & Beyond",
      icon: <Globe className="w-6 h-6 text-vivid-purple" />,
      content:
        "Apart from these, I have worked on a few projects in IoT and embedded systems too, and it has been a great experience so far! Definitely cannot wait to explore more of what the coding world has to offer and upskill myself :)",
    },
  ];
  ...
  const hobbies = [
    ...
    { icon: <Puzzle className="w-5 h-5" />, label: "Rubix Cubes" },
  ...
  return (
    <div className="min-h-screen bg-hero-gradient">
      ...
      <div className="container mx-auto px-4 py-6 flex justify-between items-center bg-soft-purple backdrop-blur-sm rounded-lg">
        <Button
        ...
        <nav className="space-x-4">
          <Link to="/projects">
            <Button
              variant="ghost"
              className="text-dark-purple hover:bg-light-purple"
            >
              Projects
            </Button>
          </Link>
          ...
          <div className="max-w-4xl mx-auto text-center flex flex-col md:flex-row items-center justify-center gap-8 relative z-10">
            <div className="flex-1">
              ...
              <Link to="/articles">
                <Button
                  size="lg"
                  className="bg-vivid-purple hover:bg-[#229AEB] text-white transition-colors"
                >
                  View My Work
                </Button>
              </Link>
      ...
      <section className="container mx-auto px-4 py-16 mt-10 bg-gradient-to-br from-light-purple/20 to-soft-blue/20 rounded-2xl">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-center text-dark-purple">
            About Me
          </h2>
          ...
          <div className="mt-8 bg-white/50 backdrop-blur-sm rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-medium text-dark-purple mb-2">
                  Motivation & Interest
                </h4>
                <p className="text-dark-purple/90">
                  I have always loved reading novels from an early age, and I
                  started writing short essays out of interest. Writing science
                  articles became a passion when I became more interested in
                  science a few years ago. Now, I enjoy reading science facts
                  and publishing them along with writing.
                </p>
              </div>
              <div>
                <h4 className="font-medium text-dark-purple mb-2">
                ...
                <p className="text-dark-purple/90">
                  I have written several science articles for school and college
                  magazines, mainly related to biology. Additionally, I have
                  worked on scripts for the hosting team, focusing on audience
                  engagement and peer perspectives. For technical writing, I am
                  currently upskilling myself in certain domains to publish tech
      ...
      <section className="container mx-auto px-4 py-16 mt-10 bg-gradient-to-br from-soft-purple/30 to-light-purple/20 rounded-2xl">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-dark-purple/90 text-center mb-8">
            Besides coding and development, I love travelling and reading
            novels. I often play the guitar and find myself deep in thought
            gazing up at the sky when something pops up in my brain.
          </p>
          <div className="flex flex-wrap justify-center gap-5">
            {hobbies.map((hobby, index) => (
              <div
                key={index}
                className="flex items-center gap-2 bg-soft-purple/50 px-5 py-3 rounded-full text-dark-purple"
              >
                {hobby.icon}
      ...
      <section className="container mx-auto px-4 py-20 mt-10 bg-gradient-to-br from-soft-blue/30 to-light-purple/20 rounded-2xl">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6 text-dark-purple">
            Let's Connect
          </h2>
          ...
          <Link to="/contact">
            <Button
              size="lg"
              className="bg-vivid-purple hover:bg-light-purple text-white transition-colors"
            >
              Get in Touch
            </Button>
          </Link>
